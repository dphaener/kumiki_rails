...
```bash
$ bin/rails generate rails_components:install
```
...
Added RailsComponents controller pins to importmap
      create  config/initializers/rails_components.rb
...
Installation Summary:
  ✓ Created config/initializers/rails_components.rb
...
Form Builder (Available):
  ...
  Option 2 - Enable as default in config/initializers/rails_components.rb:
...
Documentation & Resources:
  GitHub: https://github.com/darinhaener/rails_components
...
```bash
$ bin/rails generate rails_components:install --form-builder
```

### Key Differences:

- `config/initializers/rails_components.rb` will have `config.use_as_default_form_builder = true`
...
```bash
$ bin/rails generate rails_components:install --no-preview-system
```

### Key Differences:

- `config/initializers/rails_components.rb` will have `config.enable_preview_system = false`
...
```bash
$ bin/rails generate rails_components:install --form-builder --no-preview-system
```
...
1. **config/initializers/rails_components.rb**
