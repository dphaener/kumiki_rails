module Kumiki
  module Components
    class FormInput
      attr_reader :type, :name, :value, :placeholder, :size, :disabled, :readonly,
                  :required, :error, :object, :attribute, :html_options, :label
      ...
      def html_attributes
        ...
        # This allows attributes like min, max, step, autocomplete, etc. to pass through
        html_options.each do |key, value|
          unless [ :class, "class", :name, :value, :placeholder, :disabled, :readonly, :required, :type ].include?(key)
      ...
      def error_messages
        ...
        if object && attribute && object.respond_to?(:errors) && object.errors
