...
RSpec.describe RailsComponents::Components::FormCheckbox, type: :model do
  # Test initialization with default values
  it "initialize with defaults" do
    checkbox = RailsComponents::Components::FormCheckbox.new
  ...
  it "css classes with size" do
    checkbox = RailsComponents::Components::FormCheckbox.new(size: "lg")
    expect(checkbox.css_classes).to eq("checkbox checkbox-lg")
  end

  it "css classes with error state" do
    checkbox = RailsComponents::Components::FormCheckbox.new(error: true)
    expect(checkbox.css_classes).to eq("checkbox checkbox-error")
  end

  it "css classes with size and error" do
    checkbox = RailsComponents::Components::FormCheckbox.new(size: "sm", error: true)
  ...
  it "html attributes with checked state" do
    checkbox = RailsComponents::Components::FormCheckbox.new(checked: true)
    expected = {
      type: "checkbox",
      class: "checkbox",
      checked: true
  ...
  it "html attributes with disabled state" do
    checkbox = RailsComponents::Components::FormCheckbox.new(disabled: true)
    expected = {
      type: "checkbox",
      class: "checkbox",
      disabled: true
  ...
  it "html attributes with required state" do
    checkbox = RailsComponents::Components::FormCheckbox.new(required: true)
    expected = {
      type: "checkbox",
      class: "checkbox",
      required: true,
  ...
  it "html attributes with error and required" do
    checkbox = RailsComponents::Components::FormCheckbox.new(error: true, required: true)
    expected = {
      type: "checkbox",
      class: "checkbox checkbox-error",
      required: true,
  ...
  it "various size values" do
    %w[xs sm lg].each do |size|
      checkbox = RailsComponents::Components::FormCheckbox.new(size: size)
  ...
  it "label attribute stored correctly" do
    checkbox = RailsComponents::Components::FormCheckbox.new(label: "Subscribe to newsletter")
  ...
  it "label with html content" do
    ...
    checkbox = RailsComponents::Components::FormCheckbox.new(label: html_label)
    expect(checkbox.label).to eq(html_label)
  end

  # Test value handling
  it "default value when not specified" do
    checkbox = RailsComponents::Components::FormCheckbox.new(name: "user[newsletter]")
  ...
  it "checked state with truthy values" do
    ...
    truthy_values.each do |value|
      checkbox = RailsComponents::Components::FormCheckbox.new(checked: value)
