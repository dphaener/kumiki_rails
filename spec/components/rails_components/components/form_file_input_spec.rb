...
RSpec.describe RailsComponents::Components::FormFileInput, type: :model do
  ...
  it "html attributes with multiple state" do
    file_input = RailsComponents::Components::FormFileInput.new(multiple: true)
    expected = {
      type: "file",
      class: "file-input file-input-bordered",
      multiple: true
  ...
  it "html attributes with disabled state" do
    file_input = RailsComponents::Components::FormFileInput.new(disabled: true)
    expected = {
      type: "file",
      class: "file-input file-input-bordered",
      disabled: true
  ...
  it "html attributes with required state" do
    file_input = RailsComponents::Components::FormFileInput.new(required: true)
    expected = {
      type: "file",
      class: "file-input file-input-bordered",
      required: true,
  ...
  it "html attributes with error and required" do
    file_input = RailsComponents::Components::FormFileInput.new(error: true, required: true)
    expected = {
      type: "file",
      class: "file-input file-input-bordered file-input-error",
      required: true,
  ...
  it "various accept values" do
    ...
    test_cases.each do |accept_value|
      file_input = RailsComponents::Components::FormFileInput.new(accept: accept_value)
