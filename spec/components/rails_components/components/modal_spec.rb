...
RSpec.describe RailsComponents::Components::Modal, type: :model do
  # Test initialization with default values
  it "initialize with defaults" do
    modal = RailsComponents::Components::Modal.new
  ...
  it "html attributes with custom id" do
    modal = RailsComponents::Components::Modal.new(id: "my-modal")
    attributes = modal.html_attributes
  ...
  it "html attributes with html options" do
    ...
    modal = RailsComponents::Components::Modal.new(html_options: html_options)
    attributes = modal.html_attributes
  ...
  it "id generation uniqueness" do
    modal1 = RailsComponents::Components::Modal.new
    modal2 = RailsComponents::Components::Modal.new
  ...
  it "custom id overrides generated id" do
    modal = RailsComponents::Components::Modal.new(id: "specific-modal")
    expect(modal.id).to eq("specific-modal")
  end

  it "id from html options overrides generated id" do
    modal = RailsComponents::Components::Modal.new(html_options: { id: "html-options-modal" })
  ...
  it "whitespace only id" do
    modal = RailsComponents::Components::Modal.new(id: "   ")
  ...
  it "empty html options class" do
    modal = RailsComponents::Components::Modal.new(html_options: { class: "" })
    expect(modal.css_classes).to include("modal")
    expect(modal.css_classes).to include("modal-open")
  end
  ...
  it "various id formats" do
    ...
    test_ids.each do |id|
      modal = RailsComponents::Components::Modal.new(id: id)
  ...
  it "multiple modal instances are independent" do
    modal1 = RailsComponents::Components::Modal.new(id: "modal-1")
    modal2 = RailsComponents::Components::Modal.new(id: "modal-2")
    modal3 = RailsComponents::Components::Modal.new # Auto-generated ID
  ...
  it "id with symbol input" do
    modal = RailsComponents::Components::Modal.new(id: :symbol_modal)
