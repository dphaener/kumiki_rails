...
RSpec.describe Kumiki::Components::FormTextarea, type: :model do
  # Test initialization with default values
  it "initialize with defaults" do
    textarea = Kumiki::Components::FormTextarea.new
  ...
  it "html attributes with disabled state" do
    textarea = Kumiki::Components::FormTextarea.new(disabled: true)
    expected = {
      class: "textarea textarea-bordered",
      disabled: true
    }
  ...
  it "html attributes with readonly state" do
    textarea = Kumiki::Components::FormTextarea.new(readonly: true)
    expected = {
      class: "textarea textarea-bordered",
      readonly: true
    }
  ...
  it "html attributes with required state" do
    textarea = Kumiki::Components::FormTextarea.new(required: true)
    expected = {
      class: "textarea textarea-bordered",
      required: true,
      "aria-required": true
  ...
  it "html attributes with error and required" do
    textarea = Kumiki::Components::FormTextarea.new(error: true, required: true)
    expected = {
      class: "textarea textarea-bordered textarea-error",
      required: true,
      "aria-required": true,
  ...
  it "various size values" do
    %w[xs sm lg].each do |size|
      textarea = Kumiki::Components::FormTextarea.new(size: size)
  ...
  it "value with multiline content" do
    ...
    textarea = Kumiki::Components::FormTextarea.new(value: multiline_content)
  ...
  it "value with special characters" do
    ...
    textarea = Kumiki::Components::FormTextarea.new(value: special_content)
