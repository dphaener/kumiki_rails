...
RSpec.describe Kumiki::Components::FormRadio, type: :model do
  # Test initialization with default values
  it "initialize with defaults" do
    radio = Kumiki::Components::FormRadio.new
  ...
  it "html attributes with checked state" do
    radio = Kumiki::Components::FormRadio.new(checked: true)
    expected = {
      type: "radio",
      class: "radio",
      checked: true
  ...
  it "html attributes with disabled state" do
    radio = Kumiki::Components::FormRadio.new(disabled: true)
    expected = {
      type: "radio",
      class: "radio",
      disabled: true
  ...
  it "html attributes with required state" do
    radio = Kumiki::Components::FormRadio.new(required: true)
    expected = {
      type: "radio",
      class: "radio",
      required: true,
  ...
  it "html attributes with error and required" do
    radio = Kumiki::Components::FormRadio.new(error: true, required: true)
    expected = {
      type: "radio",
      class: "radio radio-error",
      required: true,
  ...
  it "various size values" do
    %w[xs sm lg].each do |size|
      radio = Kumiki::Components::FormRadio.new(size: size)
  ...
  it "label attribute stored correctly" do
    radio = Kumiki::Components::FormRadio.new(label: "Administrator Role")
  ...
  it "label with html content" do
    ...
    radio = Kumiki::Components::FormRadio.new(label: html_label)
  ...
  it "radio group with checked state" do
    admin_radio = Kumiki::Components::FormRadio.new(
      name: "user[role]",
      value: "admin",
      checked: true
    )

    editor_radio = Kumiki::Components::FormRadio.new(
      name: "user[role]",
      value: "editor",
      checked: false
    )
  ...
  it "checked state with truthy values" do
    ...
    truthy_values.each do |value|
      radio = Kumiki::Components::FormRadio.new(checked: value)
