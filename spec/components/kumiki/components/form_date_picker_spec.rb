...
RSpec.describe Kumiki::Components::FormDatePicker, type: :model do
  # Test initialization with default values
  it "initialize with defaults" do
    date_picker = Kumiki::Components::FormDatePicker.new
  ...
  it "html attributes with disabled state" do
    date_picker = Kumiki::Components::FormDatePicker.new(disabled: true)
    expected = {
      type: "date",
      class: "input input-bordered",
      disabled: true
  ...
  it "html attributes with readonly state" do
    date_picker = Kumiki::Components::FormDatePicker.new(readonly: true)
    expected = {
      type: "date",
      class: "input input-bordered",
      readonly: true
  ...
  it "html attributes with required state" do
    date_picker = Kumiki::Components::FormDatePicker.new(required: true)
    expected = {
      type: "date",
      class: "input input-bordered",
      required: true,
  ...
  it "html attributes with error and required" do
    date_picker = Kumiki::Components::FormDatePicker.new(error: true, required: true)
    expected = {
      type: "date",
      class: "input input-bordered input-error",
      required: true,
  ...
  it "various date input types" do
    %w[date time datetime-local month week].each do |input_type|
      date_picker = Kumiki::Components::FormDatePicker.new(type: input_type)
  ...
  it "various size values" do
    %w[xs sm lg].each do |size|
      date_picker = Kumiki::Components::FormDatePicker.new(size: size)
