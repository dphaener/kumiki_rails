...
RSpec.describe Kumiki::Components::Badge, type: :model do
  # Test initialization with default values
  it "initialize with defaults" do
    badge = Kumiki::Components::Badge.new
  ...
  it "html attributes with variant" do
    badge = Kumiki::Components::Badge.new(variant: "success")
    expected = {
  ...
  it "various variant values" do
    %w[primary secondary accent neutral info success warning error].each do |variant|
      badge = Kumiki::Components::Badge.new(variant: variant)
  ...
  it "various size values" do
    %w[xs sm md lg xl].each do |size|
      badge = Kumiki::Components::Badge.new(size: size)
  ...
  it "various style values" do
    %w[outline dash soft ghost].each do |style|
      badge = Kumiki::Components::Badge.new(style: style)
  ...
  it "empty html options class" do
    badge = Kumiki::Components::Badge.new(html_options: { class: "" })
    expect(badge.css_classes).to eq("badge")
  end
  ...
  it "badge initialization with different text values" do
    ...
    test_cases.each do |text_value|
      badge = Kumiki::Components::Badge.new(text: text_value)
  ...
  it "variant with outline style combinations" do
    %w[primary secondary accent neutral info success warning error].each do |variant|
      badge = Kumiki::Components::Badge.new(variant: variant, style: "outline")
  ...
  it "size with variant combinations" do
    ...
    sizes.each do |size|
      variants.each do |variant|
        badge = Kumiki::Components::Badge.new(size: size, variant: variant)
  ...
  it "all style variations" do
    %w[outline dash soft ghost].each do |style|
      badge = Kumiki::Components::Badge.new(variant: "primary", style: style)
  ...
  it "numeric text values" do
    ...
    numeric_values.each do |value|
      badge = Kumiki::Components::Badge.new(text: value)
      expect(badge.text).to eq(value)
    end
  end

  it "boolean text values" do
    badge_true = Kumiki::Components::Badge.new(text: true)
    badge_false = Kumiki::Components::Badge.new(text: false)
