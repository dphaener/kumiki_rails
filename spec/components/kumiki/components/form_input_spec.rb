...
RSpec.describe Kumiki::Components::FormInput, type: :model do
  # Test initialization with default values
  it "initialize with defaults" do
    input = Kumiki::Components::FormInput.new
  ...
  it "html attributes with disabled state" do
    input = Kumiki::Components::FormInput.new(disabled: true)
    expected = {
      type: "text",
  ...
  it "html attributes with readonly state" do
    input = Kumiki::Components::FormInput.new(readonly: true)
    expected = {
      type: "text",
      class: "input input-bordered",
      readonly: true
  ...
  it "html attributes with required state" do
    input = Kumiki::Components::FormInput.new(required: true)
    expected = {
      type: "text",
      class: "input input-bordered",
      required: true,
  ...
  it "html attributes with error and required" do
    input = Kumiki::Components::FormInput.new(error: true, required: true)
    expected = {
      type: "text",
      class: "input input-bordered input-error",
      required: true,
  ...
  it "various input types" do
    %w[text email password number tel url search].each do |input_type|
      input = Kumiki::Components::FormInput.new(type: input_type)
  ...
  it "various size values" do
    %w[xs sm lg].each do |size|
      input = Kumiki::Components::FormInput.new(size: size)
