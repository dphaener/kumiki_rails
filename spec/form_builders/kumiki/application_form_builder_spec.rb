...
RSpec.describe Kumiki::ApplicationFormBuilder, type: :helper do
  ...
  describe "initialization" do
    it "inherits from ActionView::Helpers::FormBuilder" do
      ...
      expect(builder).to be_kind_of(Kumiki::ApplicationFormBuilder)
    end
  ...
  describe "integration with form_with helper" do
    it "works with form_with helper" do
      output = helper.form_with(model: model, url: "/test_models", builder: Kumiki::ApplicationFormBuilder, local: true) do |form|
